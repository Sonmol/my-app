    ...
    <div className="flex h-screen w-full bg-gray-800 text-white">
      <div className="flex flex-col flex-1 justify-between">
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-4">
            <IconBleeding className="w-6 h-6" />
            <IconAttack className="w-6 h-6" />
            <IconFire className="w-6 h-6" />
            <IconPoison className="w-6 h-6" />
          </div>
        </div>
        <div className="flex-1 p-4 flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <IconHeart className="w-6 h-6" />
            <div className="w-64 h-2 bg-red-500 rounded-full" />
          </div>
          <div className="flex items-center gap-4">
            <IconApple className="w-6 h-6" />
            <div className="w-64 h-2 bg-green-500 rounded-full" />
          </div>
          <div className="flex items-center gap-4">
            <IconWater className="w-6 h-6" />
            <div className="w-64 h-2 bg-blue-500 rounded-full" />
          </div>
          <div className="flex items-center gap-4">
        ...
        <div className="flex justify-between p-4">
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <span>Sanity Status: Stable</span>
            </div>
          </div>
          <div className="flex justify-end gap-4">
            ...
            <Button>
              <IconInventory className="w-6 h-6" />
            </Button>
          </div>
        </div>
      </div>
